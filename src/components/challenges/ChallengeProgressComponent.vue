<template>
  <div class="progressDiv">
    ...
    <div class="challengeCompletionPercentageContainer">
      <p
        v-if="challengeType === 'Spare' || challengeType === 'Budsjett'"
        class="challengeCompletionPercentage"
      >
        {{ Math.floor(completionPercentage) }}%
      </p>
      <p
        v-if="challengeType === 'Forbruk'"
        class="challengeCompletionPercentage"
      >
    ...
    <div class="challengeMoneyContainer">
      <p v-if="challengeType === 'Budsjett'" class="challengeMoney">
        {{ savedAmount }}kr / {{ targetAmount }}kr brukt
      </p>
      <p v-if="challengeType === 'Spare'" class="challengeMoney">
        {{ savedAmount }}kr / {{ targetAmount }}kr spart
      </p>
    </div>
  </div>
</template>

<template>
  <div id="challengesViewDiv">
    ...
    <div id="challengesDiv">
      <ChallengeComponent
        class="challenge"
        v-for="challengeObject in challengeObjects.values()"
        :key="challengeObject.id"
        :challenge-object="challengeObject"
      />
    </div>
    <PopupComponent
      @togglePopup="toggleIsVisible"
      :is-visible="isVisible"
      ref="popup"
    >
      <template v-slot:content>
        <NewChallengeComponent
          @toggleFreeze="toggleIsFrozen"
          @close="toggleIsVisible"
        />
      </template>
    </PopupComponent>
    <SVGButtonComponent

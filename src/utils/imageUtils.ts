...
export async function uploadImage(file: File, imageUrl: Ref<string | null>): Promise<string | null> {
  ...
  if (selectedFile) {
    ...
    try {
      ...
      if (url) {
        const modifiedUrl = url.replace('https://s3.eu-north-1.amazonaws.com//quiz-project-fullstack/', 'https://quiz-project-fullstack.s3.eu-north-1.amazonaws.com/');
